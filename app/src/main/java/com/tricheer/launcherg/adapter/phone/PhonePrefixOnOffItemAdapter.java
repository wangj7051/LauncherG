...
/**
 * [Menu-Phone-Prefix-ON/OFF] List Adapter
 *
 * @author Jun.Wang
 */
public class PhonePrefixOnOffItemAdapter extends BaseFragItemAdapter<PhonePrefixOnOffFragItem> {

    public PhonePrefixOnOffItemAdapter(@NonNull Context context, @LayoutRes int resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //Fill data
        PhonePrefixOnOffFragItem item = getItem(position);
        if (item != null) {
