package com.tricheer.launcherg.adapter.security;
 ...
 * @author Jun.Wang
 */
public class SecurityMainFragItemAdapter extends BaseFragItemAdapter<SecurityMainFragItem> {

    public SecurityMainFragItemAdapter(@NonNull Context context, @LayoutRes int resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //Fill data
        SecurityMainFragItem item = getItem(position);
        if (item != null) {
