...
/**
 * [Menu-Date&time-Hour format] Fragment
 *
 * @author Jun.Wang
 */
public class DateNTimeHourFormatFragment extends BaseFragment {
    // TAG
    private static final String TAG = "HourFormatFragment";

    // Widgets
    private View fragV;

    //Variables
    private DateNTimeHourFormatActivity mAttachedActivity;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mAttachedActivity = (DateNTimeHourFormatActivity) getActivity();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragV = inflater.inflate(R.layout.frag_date_n_time_hourformat, null);
        return fragV;
    }
