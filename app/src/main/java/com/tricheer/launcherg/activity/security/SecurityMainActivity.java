...
import com.tricheer.launcherg.frags.security.SecurityMainFragment;

/**
 * Security Main Page
 */
public class SecurityMainActivity extends BaseTemplateActivity {
    /**
     * TAG
     */
     ...
     * Widgets
     */
    private SecurityMainFragment fragContent;
    ...
    protected void loadPage() {
        setPageTitle(getString(R.string.security));
        setPageTips("");
        loadContentFrag();
    }
    ...
    private void loadContentFrag() {
        if (fragContent == null) {
            fragContent = new SecurityMainFragment();
        }
